...
const PRODUCTS: {
...
}[] = [
  {
    ...
    description:
      "Integrert plattform som samler alle alarmer og ruter dem via smarttelefon med full EPJ-integrasjon.",
    icon: "network",
  ...
  },
  {
    ...
    line: "Sykehjem",
    description:
      "Trådløse alarmenheter, NFC-tilstedeværelse og nøkkelfri romtilgang for moderne omsorg.",
    icon: "homeHeart",
  ...
  },
  {
    ...
    description:
      "Touch-terminal ved sengen — TV, radio, film, musikk, spill og internett i én løsning.",
    icon: "smartphone",
  ...
  },
  {
    ...
    line: "Overfallsalarm",
    description:
      "Personlig overfallsalarm med presis posisjonering. Designet for psykiatri og akuttmottak.",
    icon: "shield",
  ...
  },
  {
    ...
    description:
      "Høyprioritets håndtering med garantert leveringsbekreftelse når det virkelig betyr alt.",
    icon: "heartPulse",
            ...
            >
              ...
              >
                <div
                  ...
                  aria-hidden
                />
                <div className="absolute inset-x-0 top-0 h-px origin-left scale-x-0 bg-gradient-to-r from-transparent via-cyan-400 to-transparent transition-transform duration-500 group-hover:scale-x-100" aria-hidden />
                ...
                <p className="mt-6 text-[10px] font-semibold uppercase tracking-[0.3em] text-ink-muted">
                  {p.line}
                </p>
                ...
                <span className="mt-6 inline-flex items-center gap-2 text-sm font-semibold text-cyan-700 transition-all group-hover:gap-3 group-hover:text-cyan-900">
                  {tc("learnMore")}
